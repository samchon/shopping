 ...
 * @author Samchon
 */
export interface IShoppingSaleQuestion extends IShoppingSaleInquiry<
  "question",
  IShoppingSaleQuestion.ISnapshot
> {
  /**
...
export namespace IShoppingSaleQuestion {
   ...
   */
  export interface IRequest extends IShoppingSaleInquiry.IRequest<
    IRequest.ISearch,
